...
KeyboardLayoutLoader {
    ...
    Component {
        ...
        KeyboardLayout {
            ...
            // Arithmetic on the number page, where someone entering figures
            ...
            // No space key here: someone entering figures is not typing words,
            // so the slot carries the way to the punctuation page instead.
            KeyboardRow {
